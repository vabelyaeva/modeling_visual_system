...
# Configuration: Oz and Cz for V1 stimulation 
...
try:
	...
	simulation.Name = "Full_head_V1_0.3mm_v6"
	...
	entity__block__oz = model.AllEntities()["Block_Oz"]
	...
	entity__block__cz_v2 = model.AllEntities()["Block_Cz_v2"]
	entity__muscle_inferior_rectus = model.AllEntities()["Muscle - Inferior Rectus"]
	entity__sensore__block__oz = model.AllEntities()["Sensore_Block_Oz"]
	...
	# Adding a new BoundarySettings
	boundary_settings = emlf.BoundarySettings()
	components = [entity__block__cz_v2]
	...
	# Adding a new ManualGridSettings
	manual_grid_settings = simulation.AddManualGridSettings([entity__block__cz_v2, entity__block__oz])
	...
	# Adding a new ManualGridSettings
	manual_grid_settings = simulation.AddManualGridSettings([entity__sensore__block__oz])
	...
	components = [entity__block__cz_v2, entity__block__oz]
